...
contract IDABFormula {
    ...
    public view returns (uint256 dptAmount, uint256 ethRemain, uint256 dCRR, uint256 dptPrice);

    function withdraw(uint256 ethBalance, uint256 dptCirculation, uint256 dptAmount)
    public view returns (uint256 ethAmount, uint256 dCRR, uint256 dptPrice);

    function cash(uint256 ethBalance, uint256 cdtSupply, uint256 cdtAmount)
    public view returns (uint256 ethAmount, uint256 cdtPrice);

    function loan(uint256 cdtAmount, uint256 interestRate, uint256 dptCRR)
    public view returns (uint256 ethAmount, uint256 ethInterest, uint256 cdtIssuanceAmount, uint256 sctAmount);

    function repay(uint256 ethRepayAmount, uint256 sctAmount)
    public view returns (uint256 ethRefundAmount, uint256 cdtAmount, uint256 sctRefundAmount);

    function toCreditToken(uint256 ethRepayAmount, uint256 dctAmount)
    public view returns (uint256 ethRefundAmount, uint256 cdtAmount, uint256 dctRefundAmount);

    function toDiscreditToken(uint256 ethBalance, uint256 dctSupply, uint256 sctAmount)
    public view returns (uint256 dctAmount, uint256 cdtPrice);
